...
export const store = reactive({
  ...
  FrontEndProjects: [
    ...
    {
      name: "Vue Streaming Movie",
      slug: "Vue-Streaming-Movie",
      poster: "vue-project-movie.png",
      technologies: [
        {
          name: "VUE Js",
          path: "vue.png",
    ...
    },
    {
      name: "Vue BoolZapp",
      slug: "Vue-BoolZapp",
      poster: "vue_boolzapp_poster.png",
      technologies: [
        {
          name: "VUE Js",
          path: "vue.png",
    ...
    {
      name: "React Ligth Cinema",
      slug: "React-Ligth-Cinema",
      poster: "react-ligth-cinema.png",
      technologies: [
        {
          name: "React",
          path: "react.png",
